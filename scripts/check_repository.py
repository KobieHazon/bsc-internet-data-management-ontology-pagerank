...
required_files = ['assignment/HW2_2018.pdf', 'src/question3a.py', 'src/question3b.py', 'src/football_ontology.py', 'src/ontology_queries.py', 'data/ontology.nt', 'results/question2c.txt', 'results/question3c.txt']
...
required_markers = ['rdflib', 'crawler', 'pr_calculator', 'ontology_prefix']
